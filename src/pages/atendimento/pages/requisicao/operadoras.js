export default function Operadoras() {
    ...
    return [
        ...
        ["416584", "ASSOCIAÇÃO FUNDO DE PROTEÇÃO À SAÚDE", "FUPS-COAMO", true, "XXX"],
        ["323080", "GEAP AUTOGESTÃO EM SAÚDE", "GEAP", true, "XXX"],
        ["326305", "AMIL ASSISTÊNCIA MÉDICA INTERNACIONAL S.A.", "AMIL", true, "XXX"],
    ]
}